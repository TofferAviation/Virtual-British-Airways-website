        ...
        <div className="site-nav-item site-nav-discover">
          ...
          <div className="site-mega-menu" aria-label="Discover menu">
            <div className="site-mega-inner">
              ...
              <div className="site-mega-column"><h3>Community</h3><Link href="/events">Events</Link><Link href="/help">Tours</Link><Link href="/help">Discord</Link><Link href="/news">News</Link></div>
