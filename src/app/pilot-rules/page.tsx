...
const rules = [
  ...
  ["06", "Aircraft registrations and fleet care", "When using Ember, reserve a dispatchable registration that matches your selected service. Do not attempt to reserve unavailable aircraft or claim an airframe belonging to another pilot. The aircraft’s hours, cycles, station and fleet logbook are operational records and must reflect a genuine BAV flight."],
