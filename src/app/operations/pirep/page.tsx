...
export const metadata = { title: "Manual PIREP fallback" };
...
export default async function ManualPirepPage() {
  ...
  return <>
    ...
    <main className="ops-page">
      <section className="ops-hero"><div className="ops-shell"><span className="ops-kicker">BAV Operations</span><h1>Manual PIREP fallback</h1><p>Ember automatically submits a linked PIREP when a tracked ACARS flight completes. Use this form only if Ember did not start or could not complete the flight.</p></div></section>
      <section className="ops-shell ops-grid">
        ...
        <div className="ops-card"><span className="ops-kicker">Manual PIREP</span><h2>Flight details</h2><form action={submitManualPirep} className="ops-form">
          ...
          <div className="ops-note"><strong>Before you submit:</strong> check Recent flight reports in your pilot account. If Ember already created a pending ACARS PIREP, do not submit this manual report as well.</div>
          ...
          <div className="ops-actions"><Link className="ops-secondary" href="/account">Cancel</Link><button className="ops-primary" type="submit">Submit manual PIREP</button></div>
        </form></div>
      </section>
    </main>
    <SiteFooter />
