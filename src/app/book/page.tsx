        ...
        <div className="page-container">
          ...
          <section className="page-heading booking-heading">
            <div>
              ...
              <p>{date} · {flexible ? "virtual-flexible BAV service catalogue" : "British Airways London-hub route catalogue"} · UTC</p>
