...
import { getPilotCareerAward } from "@/lib/pilot-awards";
...
export default async function AccountPage() {
  ...
  const careerAwards = account.awards.map((award) => ({ award, detail: getPilotCareerAward(award.id) })).sort((left, right) => left.detail.flightThreshold - right.detail.flightThreshold);
  const stats = [
