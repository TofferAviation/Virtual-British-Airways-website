...
const pilotChecklist = [
  ...
  ["2", "Choose a hub and book a BAV service", "Set London Heathrow, Gatwick or London City as your home hub in Account Settings. The home page defaults to that hub; use Browse every BAV service from the selected hub to see its full schedule. A published time is a realism reference, not a gate: use a virtual-flexible assignment when the real timetable does not suit your simulator session. Once a flight is saved, open Manage Assignment and verify the flight number, route and aircraft."],
  ...
  ["5", "Open Ember and refresh BAV flight", "Sign in to Ember with the same BAV email and password, then use Refresh BAV flight and profile. Ember should show the flight you selected on the website."],
  ...
  ["7", "Start the simulator and confirm tracking", "Connect the simulator, then start the engines or begin pushback. Ember starts the ACARS session and BA-Radar should show the live flight after its normal refresh interval. You can fly at the time that suits you; each completed full hour after the published UTC departure applies a small 0.1 VA-point ACARS adjustment. It never blocks the flight, aircraft logbook, PIREP or Tier Points."],
